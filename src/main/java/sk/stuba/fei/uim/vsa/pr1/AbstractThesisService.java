...
public abstract class AbstractThesisService<S, T, A> implements AutoCloseable {
     ...
     */
    public abstract S createStudent(Long aisId, String name, String email, String password, Integer studyYear, Integer semester, String studyProgram);
    ...
    public abstract S getStudentByAisId(Long aisId);

    public abstract S getStudentByEmail(String email);
    ...
    public abstract T getTeacherByAisId(Long aisId);

    public abstract T getTeacherByEmail(String email);
    ...
    public abstract A getThesis(String regNumber);
}
